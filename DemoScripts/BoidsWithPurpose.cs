...
namespace InteractiveAI.BehaviourScripts.BoidsWithPurposeTest
{
    public class BoidsWithPurpose : IBehaviour
    {
        ...
        private const float  FleeStrength   = 0.3f;
        ...
        public void Update()
        {
            ...
            foreach (var b in Boids)
            {
                ...
                var force = attractMode
                    ? b.Seek(clickTarget) * AttractStrength
                    : b.Flee (clickTarget) *  FleeStrength;
                b.ApplyForce(force);
